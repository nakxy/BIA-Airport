...
// Render Primary Configure and Rename Panel Items based on Active Hearder list
function renderHeader(headerOptions,mappingFlag)
        ...
        // Render Primary Dashboard Header based on Active Hearder list
